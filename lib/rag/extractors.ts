...
// Polyfill DOMMatrix for Node.js/serverless environments (required by pdf-parse/pdfjs-dist)
if (typeof globalThis.DOMMatrix === 'undefined') {
  // Minimal DOMMatrix polyfill - pdf-parse only needs basic functionality
